...
export function copyTrailsTo(injector: Injector, trails: Trail[], toCollection: TrailCollection, email: string, fromTrail: boolean, autoImportPhotos?: boolean, skipTags?: boolean, onDone?: () => void): void {
...
export function moveTrailsTo(injector: Injector, trails: Trail[], toCollection: TrailCollection, email: string, isPublishing: boolean = false): void {
  const i18n = injector.get(I18nService);
