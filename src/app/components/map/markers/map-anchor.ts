...
export class MapAnchor {
  ...
  public static createDataIcon(
    ...
    svg += '<text x="960" y="700" dominant-baseline="middle" text-anchor="middle" font-family="Arial" font-size="600px" font-weight="bold" fill="' + textColor + '" stroke="' + textColor + '">' + text + '</text>'; // TODO encode text
    svg += '</svg>';
