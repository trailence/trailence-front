...
import { MyPublicTrail, MyPublicTrailsService } from 'src/app/services/stores/my-public-trails.service';
import { MySelectionService } from 'src/app/services/stores/my-selection.service';
